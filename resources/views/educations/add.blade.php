...
<section class="w3-padding">
    ...
    <form method="post" action="/console/educations/add" novalidate class="w3-margin-bottom">
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="title" name="college_name" id="college_name" value="{{old('college_name')}}" required>
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="url" name="major" id="major" value="{{old('major')}}">
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="number" name="GPA" id="GPA" step=".01" value="{{old('GPA')}}" required>
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="date" name="start_year" id="start_year" value="{{old('start_year')}}" required>
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="date" name="end_year" id="end_year" value="{{old('end_year')}}" required>
